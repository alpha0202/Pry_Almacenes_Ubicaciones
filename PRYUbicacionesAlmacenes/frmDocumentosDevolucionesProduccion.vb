...
Public Class frmDocumentosDevolucionesProduccion
    ...
    Public Sub New(ByVal co As String, ByVal almacen As String)
        ...
        encabezado = EncabezadoMovimiento.ListEncabezadoMovimientoDVP(co, almacen)
        gcDocumentos.DataSource = encabezado
        gvDocumentos.BestFitColumns()

    End Sub

    Private Sub frmDocumentosDevolucionesProduccion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
