...
Public Class frmTrasladosMateriales_Ubicacion
    ...
    Private Sub GuardarMovimientoTRU()
        ...
        Try
            ...
            LstParametros.Add(New Parametros("@serialDvp", txt_SerialMaterial.Text, SqlDbType.VarChar))
    ...
    Private Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        ...
        If String.IsNullOrEmpty(txtUbicacionDestino.Text) Then
            XtraMessageBox.Show("Se debe escribir o selecciona una ubicación de destino.", "ADVERTENCIA", MessageBoxButtons.OK, MessageBoxIcon.Warning)
